...
(async function() {
    ...
    const categories = await Category.create([
        ...
        {name: 'Game of Thrones', videoId: 'udBMTlU-RaA', ambienceType: 'Goodbye Brother', cardImage: 'https://i.pinimg.com/564x/9b/7f/90/9b7f90334c7afcabb3b4584ea882657e.jpg', hiddenCardImage: 'https://i.pinimg.com/564x/24/5a/35/245a35d1abc8224145223234a1e8ed98.jpg', bImage:'https://res.cloudinary.com/di8ugfihk/image/upload/v1682077615/My%20Brand/philipp-scherer-got8-winterfell-north-courtyard-battle-b-skt-005b-website-copy_wwstj8.jpg', bAmbience:'https://i.pinimg.com/originals/4e/cc/7d/4ecc7dc1e9f99d83e29924e6fc2e4371.gif', bImageOpacity:100, bAmbienceOpacity:40, shadow:'violet'},
    ])
